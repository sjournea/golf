...
class MongoDBCollectionTest(MongoTestCase):
    ...
    """
        with self.db:
            ...
            # add docs
            for i in range(5):
                doc1 = {"author": "Steve", "key": "Key{0}".format(i + 1)}
                doc2 = {"author": "Ruby", "key": "Key{0}".format(i + 1)}
                coll.insert(doc1)
                coll.insert(doc2)
    ...
    """
        with self.db:
            ...
            for i in range(5):
                doc1 = {"author": "Steve", "key": "Key{0}".format(i + 1)}
                doc2 = {"author": "Ruby", "key": "Key{0}".format(i + 1)}
                doc3 = {"author": "Perl", "key": "Key{0}".format(i + 1)}
                coll.insert(doc1)
                coll.insert(doc2)
                coll.insert(doc3)
    ...
    def test_collection_find(self):
        ...
        with self.db:
            ...
            lstKeys = ["Key{0}".format(i + 1) for i in range(rec_count)]
