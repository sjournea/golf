...
class DBConnectMongo(DBConnect):
    ...
    def courseFind(self, name, **kwargs):
        """Return a list of courses."""
        return self._buildList2(
            self.courses, filter={"name": {"$regex": name}}, **kwargs
        )
    ...
    def playerFind(self, email, **kwargs):
        ...
        return self._buildList2(
            self.players, filter={"email": {"$regex": email}}, **kwargs
        )
    ...
    def roundFind(self, name, **kwargs):
        ...
        return self._buildList2(
            self.rounds, filter={"course.name": {"$regex": name}}, **kwargs
        )
