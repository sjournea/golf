...
class PuttsPlayer(GamePlayer):
    def __init__(self, game, result):
        super(PuttsPlayer, self).__init__(game, result)
...
"""
    ...
    def setup(self, **kwargs):
        """Start the game."""
        self._players = [
            PuttsPlayer(self, result) for result in self.golf_round.results
        ]
    ...
    def getLeaderboard(self, **kwargs):
        ...
        prev_total = None
        for score in scores:
            score_dct = {"player": score.player, "total": score.dct_putts["total"]}
