...
"""
    ...
    def setup(self, **kwargs):
        ...
        self._players = [
            player_class(self, result) for result in self.golf_round.results
        ]
    ...
    def update(self):
        ...
        for pl, result in zip(self._players, self.golf_round.results):
            ...
            for score in result.scores:
                ...
                pl.esc += self.golf_round.course.calcESC(
                    n, score.gross, result.course_handicap
                )
    ...
    def getLeaderboard(self, **kwargs):
        ...
        prev_total = None
        for score in scores:
            score_dct = {"player": score.player, "total": score.dct_gross["total"]}
