...
def parseTimeString(timeStr):
  ...
  """
    ...
    if timeStr.find("_") != -1:
        ...
        raise Exception(
            "Bad time string format. Expecting YYYY-MM-DD_HH:MM:SS, HH:MM:SS, or YYYY-MM-DD"
        )
    ...
    return datetime.datetime(
        dt.year, dt.month, dt.day, tm.hour, tm.minute, tm.second, tzinfo=UTC()
    )
