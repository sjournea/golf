...
class MainView(ui.View):
  ...
  def setup(self):
    self.view_names = ['RoundCreate', 'RoundGames', 'RoundScores', 'RoundLeaderboard','RoundScorecard']
    self.view_index = -1
    self.view_array = []
    ...
    for i in range(len(self.view_names)):
      self.view_index += 1
      self.view_array.append(ui.load_view('views/' + self.view_names[self.view_index]))
